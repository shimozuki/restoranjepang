...
<div class="header head">
	<div class="container">
		...
		<h1 style="float: left"><a href="index.php"><span>Ichi</span><img src="images/oo.png" alt="">raku</a>
		</div>
...
<div class="blog">
	<div class="container">
		...
		<div class="leave">
			...
			<form action="register_code.php" onsubmit="return validation()" role="form" method="post" name="cust_login" id="cust_login">
...
<script> 
    ...
    var phone = document.cust_login.contactNo.value; 
	var n = phone.length;
	document.getElementById("textbox3").innerHTML = n;
   ...
   if (n=10)
	...
	{
		window.alert("Your Mobile Number must be 1 to 10 Integers"); 
		return false;    
    }
